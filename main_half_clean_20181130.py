...
if args.mode == 2:
	...
	if args.resume:
		...
		best_acc = 0
	params = paramsget()
	mask_group_prune = getGroupPruningMask(params)
...
# Retraining
def groupPruningOne(epoch, mask_group_prune):
	print('\nEpoch: %d' % epoch)
	global best_acc
	net.train()
	train_loss = 0
...
if mode == 0: # only inference
	...
	for epoch in range(0,50):
		groupPruningOne(epoch, mask_group_prune) 
