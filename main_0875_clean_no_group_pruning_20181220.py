...
parser.add_argument('--network', default='ckpt_20181220_0875_clean.t0', help='input network ckpt name', metavar="FILE")
parser.add_argument('--network2', default='ckpt_20181220_0875_clean_prune_80.t0', help='input network ckpt name', metavar="FILE")
parser.add_argument('--outputfile', default='ckpt_20181220_0875_clean.t0', help='output file name', metavar="FILE")
...
def train(epoch):
	...
	mask_channel = set_mask(mask_channel, 1, 1)
