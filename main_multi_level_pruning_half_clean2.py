...
parser.add_argument('--network', default='ckpt_20190109_half_clean_prune_959085.t0', help='input network ckpt name', metavar="FILE")
parser.add_argument('--network2', default='ckpt_20190109_half_clean_prune_9590.t0', help='input network ckpt name', metavar="FILE")
parser.add_argument('--outputfile', default='ckpt_20190109_half_clean_prune_959085.t0', help='output file name', metavar="FILE")
